...
coarse_train = dict(
    ...
    ray_sampler='random',         # ray sampling strategies random
    ...
    weight_alphainv_last=0,       # alpha sueprvision for real-world scenes to learn clean background.
...
fine_train.update(dict(
    N_iters=20000,
    pervoxel_lr=False,
    ray_sampler='in_maskcache',             # in_maskcache
...
fine_model_and_render.update(dict(
    ...
    world_bound_scale=1.2,       # enlarge bbox for modelling dynamic scenes.
))
